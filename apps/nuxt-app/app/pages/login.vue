<script setup lang="ts">
  ...
  const loginWithOAuth = async (provider: string) => {
    try {
      ...
      const data = await $fetch<OAuthResponse>(
        `/api/auth/${provider}`
      )
  ...
  >
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      ...
      >
        ...
        <div
          class="mb-6 p-3 bg-blue-50 rounded-md text-sm text-blue-700"
        >
          <p>
            Using Hanko URL:
            <code
              class="font-mono bg-blue-100 px-2 py-1 rounded"
            >
              https://c4a5a608-41fc-4c69-abdd-75e5f63315e9.hanko.io
            </code>
          </p>
        </div>
