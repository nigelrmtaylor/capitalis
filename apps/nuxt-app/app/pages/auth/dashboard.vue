      ...
      <div class="max-w-7xl mx-auto pb-12 px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow px-5 py-6 sm:px-6">
          <div class="flex justify-between items-center">
            ...
            >
              <NuxtIcon name="heroicons:arrow-left-on-rectangle" class="-ml-1 mr-2 h-5 w-5" />
              Sign out
            </button>
          </div>
          ...
          <div class="mt-6 border-t border-gray-200 pt-6">
            ...
            <div class="mt-4">
              <p class="text-sm text-gray-500">
                <span class="font-medium text-gray-700">Email:</span> {{ user?.email || 'Loading...' }}
              </p>
              <p class="mt-2 text-sm text-gray-500">
                <span class="font-medium text-gray-700">User ID:</span> {{ user?.id || 'Loading...' }}
              </p>
            </div>
          </div>
        </div>
